...
<metadata xmlns:ame="http://www.ataccama.com/ame/md">
	...
	<systems>
		<system ame:include="md/connected_systems/system_Golem.md"/>
		<system ame:include="md/connected_systems/system_KoopGolem.md"/>
		<system ame:include="md/connected_systems/system_TestBatchCSV.md"/>
	</systems>
	<logicalModel>
		<instanceModel ame:include="md/logical_model/instance_model.md"/>
		<masterModels>
			<masterModel ame:include="md/logical_model/master_Model_master_party.md"/>
		</masterModels>
